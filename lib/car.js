...
var Car = function (image, performance) {
  ...
  this.dynamics = { speed: 0, steering: 0, centrifuge: 0, drag: 0 };
...
Car.prototype.speedControl = function (segment) {
  this.dynamics.speed *= this.getDragFactor();
...
Car.prototype.getDragFactor = function (segment) {
  return this.physics.drag * (1 - this.dynamics.drag);
}
