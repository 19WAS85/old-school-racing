...
CarRender.prototype.getRelativePosition = function () {
  return {
    x: this.car.position.x - this.raceRender.race.player.position.x,
    y: this.car.position.y - this.raceRender.race.player.position.y,
    z: this.car.position.z - this.raceRender.race.player.position.z
  };
}
