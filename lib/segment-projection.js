...
SegmentProjection.prototype.create = function (status, segment, topography, needDraw) {
  var isSegmentLooped = segment.index < status.baseSegmentIndex;
  var loopedZ = isSegmentLooped ? status.track.length : 0;
  var segmentZ = segment.length - status.baseZ + loopedZ;
