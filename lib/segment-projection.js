...
SegmentProjection.prototype.project = function (s, t, baseIndex, z, draw) {
  var isSegmentLooped = s.index < baseIndex;
  var loopedZ = isSegmentLooped ? this.trackRender.track.length : 0;
  var segmentZ = s.length - z + loopedZ;
...
SegmentProjection.prototype.createLines = function (segment, start, end) {
  if (segment.index % 4 != 0) return null;
